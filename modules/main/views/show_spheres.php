      ...
      <div class="container_24  pad1">
        <div class="wrapper">
          <article class="grid_22 prefix_1 suffix_1 alpha omega">
            <figure class="img-indent-r border-1"><img width="167" height="143" src="/<?php echo $practik->main_image();?>" alt=""></figure>
            <div class="extra-wrap">
              <h3 class="pad4"><?php echo $practik->name();?></h3>
              <?php echo $practik->desc();?>
            </div>
          </article>
        </div>
      </div>
