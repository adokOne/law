;(function($) {
  ...
  $.Controller = (function() {
    function Controller(name, obj, subs, ancestorClass) {
      ...
      var defaultEvents = "change click contextmenu dblclick keydown keyup keypress mousedown mousemove mouseout mouseover mouseup reset resize scroll select submit focus blur focusin focusout mouseenter mouseleave draginit dragstart drag dragend shown".split(" ");
